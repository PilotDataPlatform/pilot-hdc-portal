...
const ORGANIZATION_PORTAL_DOMAIN = process.env.REACT_APP_ORGANIZATION_PORTAL_DOMAIN;
const PLATFORM_INTRODUCTION_URL = process.env.REACT_APP_PLATFORM_INTRODUCTION_URL;
...
const IS_CENTRAL_NODE_FUNCTIONALITY_ENABLED = (process.env.REACT_APP_IS_CENTRAL_NODE_FUNCTIONALITY_ENABLED || '').toLowerCase() === 'true';
const IS_CORE_ZONE_FUNCTIONALITY_ENABLED = (process.env.REACT_APP_IS_CORE_ZONE_FUNCTIONALITY_ENABLED || '').toLowerCase() !== 'false';
const IS_WORKBENCH_FUNCTIONALITY_ENABLED = (process.env.REACT_APP_IS_WORKBENCH_FUNCTIONALITY_ENABLED || '').toLowerCase() !== 'false';
const IS_DATASET_FUNCTIONALITY_ENABLED = (process.env.REACT_APP_IS_DATASET_FUNCTIONALITY_ENABLED || '').toLowerCase() !== 'false';
const IS_SEARCH_FUNCTIONALITY_ENABLED = (process.env.REACT_APP_IS_SEARCH_FUNCTIONALITY_ENABLED || '').toLowerCase() !== 'false';
const IS_MAINTENANCE_ANNOUNCEMENT_FUNCTIONALITY_ENABLED = (process.env.REACT_APP_IS_MAINTENANCE_ANNOUNCEMENT_FUNCTIONALITY_ENABLED || '').toLowerCase() !== 'false';
const IS_NOTIFICATION_FUNCTIONALITY_ENABLED = (process.env.REACT_APP_IS_NOTIFICATION_FUNCTIONALITY_ENABLED || '').toLowerCase() !== 'false';
const IS_INVITATION_FUNCTIONALITY_ENABLED = (process.env.REACT_APP_IS_INVITATION_FUNCTIONALITY_ENABLED || '').toLowerCase() !== 'false';
const IS_LINEAGE_FUNCTIONALITY_ENABLED = (process.env.REACT_APP_IS_LINEAGE_FUNCTIONALITY_ENABLED || '').toLowerCase() !== 'false';
