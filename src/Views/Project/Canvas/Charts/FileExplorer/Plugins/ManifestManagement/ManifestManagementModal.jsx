...
const ManifestManagementModal = ({
  ...
  const handleOk = async () => {
    if (step === 1) {
      ...
      let attrsParams = { ...attrForm };
      for (let tplAttr of selManifest.attributes) {
        const keyName = tplAttr.name;
        if (tplAttr.optional && typeof attrsParams[keyName] === 'undefined') {
          attrsParams[keyName] = '';
        }
      }
      try {
                ...
                return (
                  <>
                    ...
                    <div>
                      ...
                      >
                        {attr.optional && <Option value="">N/A</Option>}
