...
export const DELETE_UPLOAD_LIST_ITEM = 'DELETE_UPLOAD_LIST_ITEM';

export const SET_RESUMABLE_LIST = 'SET_RESUMABLE_LIST';

export const ADD_RESUMABLE_LIST = 'ADD_RESUMABLE_LIST';

export const UPDATE_RESUMABLE_LIST_ITEM = 'UPDATE_RESUMABLE_LIST_ITEM';
...
export const ADD_COPY2CORE_LIST = 'ADD_COPY2CORE_LIST';

export const UPDATE_COPY2CORE_LIST = 'UPDATE_COPY2CORE_LIST';

export const SET_COPY2_CORE_LIST = 'SET_COPY2_CORE_LIST';
...
export const SET_KG_SPACE_BIND = 'SET_KG_SPACE_BIND';

export const SET_CURRENT_PROJECT_TEMPLATES = 'SET_CURRENT_PROJECT_TEMPLATES';
...
export const SET_MOVED_TO_BIN_LIST = 'SET_MOVED_TO_BIN_LIST';
export const UPDATE_MOVED_TO_BIN_LIST = 'UPDATE_MOVED_TO_BIN_LIST';
export const ADD_MOVED_TO_BIN_LIST = 'ADD_MOVED_TO_BIN_LIST';
...
export const DATASET_INFO = {
  ...
  SET_PROJECT_CODE: 'DATASET_INFO.SET_PROJECT_CODE',
...
export const DATASET_FILE_OPERATION = {
  ...
  UPDATE_MOVE: 'DATASET_FILE_OPERATION.UPDATE_MOVE',
  SET_IMPORT: 'DATASET_FILE_OPERATION.SET_IMPORT',
  UPDATE_IMPORT: 'DATASET_FILE_OPERATION.UPDATE_IMPORT',
  SET_RENAME: 'DATASET_FILE_OPERATION.SET_RENAME',
  UPDATE_RENAME: 'DATASET_FILE_OPERATION.UPDATE_RENAME',
  SET_DELETE: 'DATASET_FILE_OPERATION.SET_DELETE',
  UPDATE_DELETE: 'DATASET_FILE_OPERATION.UPDATE_DELETE',
};

export const SCHEMA_TEMPLATES = {
  UPDATE_DEFAULT_SCHEMA_LIST: 'UPDATE_DEFAULT_SCHEMA_LIST',
  UPDATE_KG_SCHEMA_META_LIST: 'UPDATE_KG_SCHEMA_META_LIST',
...
export const BELLNOTIFICATION = {
  SET_ACTIVE_BELL_NOTIFICATION: 'SET_ACTIVE_BELL_NOTIFICATION',
};

export const SET_VIRTUAL_FOLDER_OPERATION = 'SET_VIRTUAL_FOLDER_OPERATION';

export const SET_UPLOAD_COMMITTING = 'SET_UPLOAD_COMMITTING';
export const SET_DOWNLOAD_COMMITTING = 'SET_DOWNLOAD_COMMITTING';
export const UNSET_DOWNLOAD_COMMITTING = 'UNSET_DOWNLOAD_COMMITTING';
